...
"%1$s:dbname%2$s %3$sname%4$s         %5$sView or set database for queries (v4.0+)%6$s\n"
"%1$s:format%2$s %3$s(table|csv)%4$s    %5$sSet the output format%6$s\n"
"%1$s:width%2$s %3$s(<n>|auto)%4$s      %5$sSet the number of columns in the table output%6$s\n"	    
